...
exports.GrpcService = exports.ObjectToStructConverter = void 0;
/*!
...
class ObjectToStructConverter {
    ...
    convert(obj) {
        ...
        for (const prop in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, prop)) {
                ...
                if ((0, helper_1.isUndefined)(value)) {
                    continue;
                }
    ...
    encodeValue_(value) {
        let convertedValue;
        if ((0, helper_1.isNull)(value)) {
            convertedValue = {
                nullValue: 0,
            };
        }
        else if ((0, helper_1.isNumber)(value)) {
            convertedValue = {
                numberValue: value,
            };
        }
        else if ((0, helper_1.isString)(value)) {
            convertedValue = {
                stringValue: value,
            };
        }
        else if ((0, helper_1.isBoolean)(value)) {
            convertedValue = {
                boolValue: value,
            };
        }
        ...
        else if ((0, helper_1.isObject)(value)) {
        ...
        else if ((0, helper_1.isArray)(value)) {
            convertedValue = {
                listValue: {
...
class GrpcService extends common_1.Service {
    ...
    constructor(config, options) {
        ...
        if (config.grpc) {
            ...
            this.grpc = google_gax_1.grpc;
            this.grpcVersion = 'grpc/' + new google_gax_1.GrpcClient().grpcVersion;
        }
    ...
    requestStream(pOpts, rOpts) {
        ...
        let reqOpts = rOpts;
        if (!protoOpts.stream) {
            protoOpts.stream = new stream_1.PassThrough({ objectMode: true });
        }
        ...
        const retryOpts = Object.assign({
            ...
            shouldRetryFn: GrpcService.shouldRetryRequest_,
            request() {
                const ee = service[protoOpts.method](reqOpts, grpcMetadata, grpcOpts).on('metadata', () => {
    ...
    requestWritableStream(protoOpts, reqOpts) {
        ...
        const grpcMetadata = this.grpcMetadata;
        const grpcOpts = {};
        if ((0, helper_1.isNumber)(protoOpts.timeout)) {
            grpcOpts.deadline = GrpcService.createDeadline_(protoOpts.timeout);
        }
        try {
            reqOpts = this.decorateRequest_(reqOpts);
    ...
    static decorateError_(err) {
        const errorObj = (0, helper_1.isError)(err) ? err : {};
    ...
    decorateRequest_(reqOpts) {
        ...
        return (0, projectify_1.replaceProjectIdToken)(reqOpts, this.projectId);
    }
    /**
    ...
    getGrpcCredentials_(callback) {
        this.authClient.getClient().then(client => {
            const credentials = this.grpc.credentials.combineChannelCredentials(this.grpc.credentials.createSsl(), google_gax_1.grpc.credentials.createFromGoogleCredential({
    ...
    loadProtoFile(protoPath, config) {
        ...
        if (!GrpcService.protoObjectCache[protoObjectCacheKey]) {
            const services = (0, proto_loader_1.loadSync)(protoPath, {
                keepCase: false,
                defaults: true,
                bytes: String,
                longs: String,
