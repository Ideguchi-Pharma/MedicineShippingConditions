...
class MetricsTracer {
     ...
     */
    constructor(_instrumentAttemptCounter, _instrumentAttemptLatency, _instrumentOperationCounter, _instrumentOperationLatency, _instrumentGfeConnectivityErrorCount, _instrumentGfeLatency, _instrumentAfeConnectivityErrorCount, _instrumentAfeLatency, enabled, _database, _instance, _methodName, _request) {
    ...
    recordOperationCompletion() {
        ...
        metrics_tracer_factory_1.MetricsTracerFactory.getInstance().clearCurrentTracer(this._request);
    }
    /**
