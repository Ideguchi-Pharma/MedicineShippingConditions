...
class Interval {
    ...
    static fromSeconds(seconds) {
        if (!(0, helper_1.isInteger)(seconds)) {
    ...
    static fromMilliseconds(milliseconds) {
        if (!(0, helper_1.isInteger)(milliseconds)) {
    ...
    static fromMicroseconds(microseconds) {
        if (!(0, helper_1.isInteger)(microseconds)) {
...
function encodeValue(value) {
    if ((0, helper_1.isNumber)(value) && !(0, helper_1.isDecimal)(value)) {
        return value.toString();
    }
    if ((0, helper_1.isDate)(value)) {
        return value.toJSON();
    }
...
function getType(value) {
    const isSpecialNumber = (0, helper_1.isInfinite)(value) || ((0, helper_1.isNumber)(value) && isNaN(value));
    if (value instanceof Float32) {
        return { type: 'float32' };
    }
    if ((0, helper_1.isDecimal)(value) || isSpecialNumber || value instanceof Float) {
        return { type: 'float64' };
    }
    if ((0, helper_1.isNumber)(value) || value instanceof Int) {
        return { type: 'int64' };
    }
    if (value instanceof Numeric) {
        return { type: 'numeric' };
    ...
    if ((0, helper_1.isBoolean)(value)) {
        return { type: 'bool' };
    }
    if ((0, helper_1.isString)(value)) {
        return { type: 'string' };
    }
    if (Buffer.isBuffer(value)) {
        return { type: 'bytes' };
