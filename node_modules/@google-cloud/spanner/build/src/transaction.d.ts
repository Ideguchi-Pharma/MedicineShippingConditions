...
type PrecommitTokenProvider = spannerClient.spanner.v1.ITransaction | spannerClient.spanner.v1.IPartialResultSet | spannerClient.spanner.v1.IExecuteBatchDmlResponse | spannerClient.spanner.v1.ICommitResponse;
/**
...
export declare class Snapshot extends EventEmitter {
    ...
    protected _latestPreCommitToken: spannerClient.spanner.v1.IMultiplexedSessionPrecommitToken | undefined | null;
     ...
     */
    protected _setMutationKey(mutations: spannerClient.spanner.v1.Mutation[]): void;
    /**
     ...
     */
    protected _setPreviousTransactionId(transaction: spannerClient.spanner.v1.ITransactionSelector): void;
    /**
...
export declare class Transaction extends Dml {
    ...
    setReadWriteTransactionOptions(options: RunTransactionOptions): void;
}
/**
 ...
 * ```
 */
export declare class MutationSet {
    /**
 ...
 * ```
 */
export declare class MutationGroup {
    private _proto;
    constructor();
    insert(table: string, rows: object | object[]): void;
    update(table: string, rows: object | object[]): void;
