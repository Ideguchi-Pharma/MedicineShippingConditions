...
class PartialResultStream extends stream_1.Transform {
    ...
    _transform(chunk, enc, next) {
        ...
        let res = true;
        if (!(0, helper_1.isEmpty)(chunk.values)) {
    ...
    static merge(type, head, tail) {
        ...
        if ((0, helper_1.isString)(head) && (0, helper_1.isString)(tail)) {
            return [head + tail];
        }
        return [head, tail];
    }
...
function partialResultStream(requestFn, options) {
    ...
    const makeRequest = () => {
        if ((0, helper_1.isDefined)(lastResumeToken) && lastResumeToken.length > 0) {
...
function _hasResumeToken(chunk) {
    return (0, helper_1.isDefined)(chunk.resumeToken) && chunk.resumeToken.length > 0;
}
