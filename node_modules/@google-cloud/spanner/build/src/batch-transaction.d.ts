 ...
 */
import { ExecuteSqlRequest, ReadCallback, ReadRequest, ReadResponse, RunCallback, RunResponse, Snapshot } from './transaction';
import { google } from '../protos/protos';
import { Session } from '.';
import { ResourceCallback } from '../src/common';
...
export type CreateReadPartitionsCallback = ResourceCallback<ReadRequest[], google.spanner.v1.IPartitionResponse>;
export type CreateQueryPartitionsResponse = [
    ExecuteSqlRequest[],
    google.spanner.v1.IPartitionResponse
];
export type CreateQueryPartitionsCallback = ResourceCallback<ExecuteSqlRequest[], google.spanner.v1.IPartitionResponse>;
/**
...
declare class BatchTransaction extends Snapshot {
     ...
     */
    createQueryPartitions(query: string | ExecuteSqlRequest): Promise<CreateQueryPartitionsResponse>;
    createQueryPartitions(query: string | ExecuteSqlRequest, callback: CreateQueryPartitionsCallback): void;
     ...
     */
    createReadPartitions(options: ReadRequest): Promise<CreateReadPartitionsResponse>;
    createReadPartitions(options: ReadRequest, callback: CreateReadPartitionsCallback): void;
    /**
     ...
     */
    execute(partition: ReadRequest | ExecuteSqlRequest): Promise<ReadResponse | RunResponse>;
    execute(partition: ReadRequest | ExecuteSqlRequest, callback: ReadCallback | RunCallback): void;
    /**
