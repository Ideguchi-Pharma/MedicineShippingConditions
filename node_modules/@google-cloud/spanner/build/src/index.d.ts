...
import { Float32, Float, Int, Numeric, PGNumeric, PGJsonb, SpannerDate, Interval, Struct, ProtoMessage, ProtoEnum, IProtoMessageParams, IProtoEnumParams } from './codec';
...
import { MutationGroup, MutationSet, PartitionedDml, Snapshot, Transaction } from './transaction';
import * as v1 from './v1';
import { ObservabilityOptions } from './instrument';
export type IOperation = instanceAdmin.longrunning.IOperation;
export type GetInstancesOptions = PagedOptionsWithFilter;
export type GetInstancesResponse = PagedResponse<Instance, instanceAdmin.spanner.admin.instance.v1.IListInstancesResponse>;
export type GetInstancesCallback = PagedCallback<Instance, instanceAdmin.spanner.admin.instance.v1.IListInstancesResponse>;
export type GetInstanceConfigsOptions = PagedOptions;
export type GetInstanceConfigsResponse = PagedResponse<instanceAdmin.spanner.admin.instance.v1.IInstanceConfig, instanceAdmin.spanner.admin.instance.v1.IListInstanceConfigsResponse>;
export type GetInstanceConfigsCallback = PagedCallback<instanceAdmin.spanner.admin.instance.v1.IInstanceConfig, instanceAdmin.spanner.admin.instance.v1.IListInstanceConfigsResponse>;
...
export type GetInstanceConfigOperationsResponse = PagedResponse<IOperation, instanceAdmin.spanner.admin.instance.v1.IListInstanceConfigOperationsResponse>;
export type GetInstanceConfigOperationsCallback = PagedCallback<IOperation, instanceAdmin.spanner.admin.instance.v1.IListInstanceConfigOperationsResponse>;
/**
 ...
 */
export type TranslateEnumKeys<T, U extends keyof T, E extends {
    [index: string]: unknown;
}> = {
...
declare class Spanner extends GrpcService {
    ...
    private _isEmulatorEnabled;
    private static _isAFEServerTimingEnabled;
     ...
     */
    static isAFEServerTimingEnabled: () => boolean;
    /** Resets the cached value (use in tests if env changes). */
    static _resetAFEServerTimingForTest(): void;
    /**
     ...
     * ```
     */
    static float32(value: any): Float32;
    /**
